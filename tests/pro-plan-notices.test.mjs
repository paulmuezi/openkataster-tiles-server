...
assert.match(stylesSource, /\.selection-data-table \.selection-pro-notice td \{ position: static;/);
...
assert.match(appSource, /\.\/selection\.js\?v=20260714-pro-notice-rows1/);
assert.match(indexSource, /styles\.css\?v=20260714-aligned-table-columns1/);
assert.match(indexSource, /app\.js\?v=20260714-pro-notice-rows1/);
